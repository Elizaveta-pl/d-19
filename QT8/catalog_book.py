...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(600, 50, 130, 180))
    ...
    def clickedRowColumn(self, r, c):
        # print(f'r = {r} c = {c}')
        # print(self.checkWidget.item(r,5))
        # print(self.checkWidget.setCurrentCell(r, 5))
        # print(self.checkWidget.currentIndex())
        self.update_image(r)
        # con = sqlite3.connect('catalog_1.db')

        # text_sql_base = f'SELECT photo FROM book  WHERE id = {r}'
    ...
    def search(self):
        ...
        print(f'self.textEdit.toPlainText().strip()[0] = {self.textEdit.toPlainText().strip()}')
